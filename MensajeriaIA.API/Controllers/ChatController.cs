...
public class ChatController : ControllerBase
{
    ...
    public ChatController(ChatRepository repo, SimuladorIAService iaService, IHubContext<ChatHub> hubContext)
    {
        _repo = repo;
    ...
    public async Task<IActionResult> EnviarMensaje(Guid id, [FromBody] NuevoMensajeRequest request)
    {
        ...
        int costoLlamada = 5;
        int saldoRestante = await _repo.DescontarCreditosLlamadaIAAsync(userId, costoLlamada);
        ...
        return Accepted(new { Mensaje = "Procesando...", SaldoRestante = saldoRestante });
    }
